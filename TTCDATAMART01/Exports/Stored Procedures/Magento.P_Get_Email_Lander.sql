...
--	US3206	01/25/201	BryantJ			Moved to Exports DB(as well as all associated tables), renamed objects to the new EmailLander names
------------------------------------------------------------------------------------------------------------------------------------------         
CREATE PROCEDURE [Magento].[P_Get_Email_Lander]
AS
BEGIN 
	SET NOCOUNT ON
