CREATE TABLE [dbo].[TEMP_TRACKING]
(
...
GO
GRANT REFERENCES ON  [dbo].[TEMP_TRACKING] TO [TEACHCO\OLTP_DATA Group]
GO
GRANT SELECT ON  [dbo].[TEMP_TRACKING] TO [TEACHCO\OLTP_DATA Group]
GO
