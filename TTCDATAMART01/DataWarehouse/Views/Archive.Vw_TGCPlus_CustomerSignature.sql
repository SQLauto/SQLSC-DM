...
as      
Select A.*,B.DSMonthCancelled_New,DS,BillingRank,LTDPaymentRank,
LTDNetPaymentRank,LTDAmount as DSLTDAmount,LTDNetAmount as DSLTDNetAmount  , isnull(B.Reactivated,0)Reactivated  ,Isnull(RFM.RFMGroup,'NA')RFMGroup  
from      
