...
CREATE view [dbo].[VW_TGCplus_VideoEvents_Smry_del]
as
...
--	select uuid,U.ID,d.date  
--	from DataWarehouse.Mapping.Date d,Datawarehouse.Marketing.TGCplus_VideoEvents_Smry U
--	where d.date between cast(dateadd(yyyy,-2,getdate()) as date) and cast( getdate() as date)
--	--and id = 937720
--) d 
