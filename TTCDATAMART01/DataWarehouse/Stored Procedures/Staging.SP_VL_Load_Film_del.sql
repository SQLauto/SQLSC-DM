...
CREATE Proc [Staging].[SP_VL_Load_Film_del]      
as      
Begin      
      
       
/*Truncate and Load */      
--Truncate table [Archive].[TGCPlus_Film_del]      

Delete A from [Archive].[TGCPlus_Film_del] A  
inner join [Staging].VL_ssis_Film  S  
on a.id = s.id  
  
      
insert into [Archive].[TGCPlus_Film_del]      
