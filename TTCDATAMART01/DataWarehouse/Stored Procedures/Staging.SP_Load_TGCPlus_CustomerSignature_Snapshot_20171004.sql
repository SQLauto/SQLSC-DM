...
CREATE Proc [Staging].[SP_Load_TGCPlus_CustomerSignature_Snapshot_20171004] @SnapshotDate Date = null
as
...
exec [Staging].[SP_Load_TGCPlus_Transaction_Snapshot] @Date = @SnapshotDate
