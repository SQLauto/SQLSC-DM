...
CREATE proc [dbo].[Sp_EPC_EmailPull_CYC_20160401]        
as        
Begin        
...
/* removing customers who are not in US*/  
delete e  
from staging.EPC_EmailPullCYC e  
...
where EmailID = @EmailID and DLRFlag = 0 and segmentGroup = 'Active match' and countrycode= 'US'     and CYC = 1   
...
where EmailID = @EmailID and DLRFlag = 0 and segmentGroup = 'Active Nomatch' and countrycode= 'US'     and CYC = 1   
