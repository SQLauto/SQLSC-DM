...
/*Removing any customers who do not have any customerid ex: plus customers who were added to 2018 deepswamp3 mailing*/   
...
/*When we have gift customers in the mailfile and since they do not have customerid we drop them */    
print 'deletes due to customerid Nulls'    
delete from datawarehouse.archive.ToMH_PM_MailFile_test          
...
*/          
 ...
 inner join ( select top 1 adcode           
  ...
  where adcode in           
   ...
   where countrycd='US' and map.PMUpdateflag=0 )) PM           
