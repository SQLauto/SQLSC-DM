...
CREATE PROCEDURE [Staging].[SP_MC_LoadTGCDigitalConsumptionL12MnthSmry]
	@AsOfDate date = null
AS
BEGIN
	set nocount on
	...
	if @AsOfDate >= '1/1/2017'
		begin
			...
			where ActionDate <  @AsOfDate  --  '1/1/2018' --@AsOfDate
	...
	from Marketing.DMPurchaseOrdersIgnoreReturns a join
		...
		where DateOrdered <  @AsOfDate --'1/1/2018' --@AsOfDate
	...
	select a.CustomerID
		,@AsOfDate as AsOfDate --'1/1/2018' as AsoFdate --
	...
	select a.CustomerID
		,@AsOfDate as AsOfDate --'1/1/2018' as AsoFdate --@AsOfDate as AsOfDate
		,a.DateOrdered as LastOrderDate
		,a.StartDate
		,a.MinActionDate
		,a.MaxActionDate
