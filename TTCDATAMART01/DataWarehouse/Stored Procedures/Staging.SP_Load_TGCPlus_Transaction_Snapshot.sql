...
CREATE PROC [Staging].[SP_Load_TGCPlus_Transaction_Snapshot] @Date Date = null
As
Begin
...
IF OBJECT_ID('Archive.TGCPlus_Transaction_Snapshot') IS NOT NULL
DROP TABLE Archive.TGCPlus_Transaction_Snapshot
...
INTO Archive.TGCPlus_Transaction_Snapshot
...
IF OBJECT_ID('Archive.TGCPlus_CustomerStatus_Snapshot') IS NOT NULL
DROP TABLE Archive.TGCPlus_CustomerStatus_Snapshot
...
,GETDATE() AS DMLastupdated
--INTO ##TGCPlus_QC
INTO Archive.TGCPlus_CustomerStatus_Snapshot
FROM Archive.TGCPlus_Transaction_Snapshot F
...
Payments
FROM Archive.TGCPlus_Transaction_Snapshot GROUP BY Customerid ) F1
