...
CREATE Proc [dbo].[SP_TGCPLus_Load_DS_offercode]
As
...
---Additional Issues
 ...
 --order by 3,2
  ...
  Amount,NetAmount,DSSplits,PaidFlag,BillingDupes,	UBIssue ,MinDSDate,MaxDSDate, Case when Coalesce_DSDate = MaxDSDate then 1 else 0 end as MaxDS,uso_offer_id,uso_offer_code_applied,uso_applied_at,
