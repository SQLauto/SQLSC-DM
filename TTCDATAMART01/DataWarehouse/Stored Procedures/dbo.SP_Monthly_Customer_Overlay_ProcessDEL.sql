...
Create Proc [dbo].[SP_Monthly_Customer_Overlay_ProcessDEL]    
as    
Begin    
...
drop table datawarehouse.Mapping.CustomerOverlay_WD_PR2    
 ...
 into datawarehouse.mapping.CustomerOverlay_WD_PR2         
 from datawarehouse..TTC_Net_Name_pipe    
    
  
   
    --/* Insert new records*/     
 --insert into DataWarehouse.Mapping.CustomerOverlay_WD_PR    
 ...
 --from DataWarehouse.Mapping.CustomerOverlay_WD_PR2 a left join    
 --DataWarehouse.Mapping.CustomerOverlay_WD_PR b on a.CustomerID = b.CustomerID    
 --where b.CustomerID is null and a.CustomerID <1000000000
    
/* Insert new records TGC PLus*/     
 insert into DataWarehouse.Mapping.TGCPlus_CustomerOverlay_PR     
 ...
 from DataWarehouse.Mapping.CustomerOverlay_WD_PR2 a left join    
 DataWarehouse.Mapping.TGCPlus_CustomerOverlay_PR b on a.CustomerID = b.CustomerID + 1000000000    
 where b.CustomerID is null and a.CustomerID > 1000000000   
 ...
 --from DataWarehouse.Mapping.CustomerOverlay_WD_PR a join    
 --DataWarehouse.Mapping.CustomerOverlay_WD_PR2 b on a.CustomerID = b.CustomerID    
 ...
 a.WdScore = b.wDScore,    
 a.WdRawScore = b.wdrawscore
 from DataWarehouse.Mapping.TGCPlus_CustomerOverlay_PR a join    
 DataWarehouse.Mapping.CustomerOverlay_WD_PR2 b on a.CustomerID + 1000000000  = b.CustomerID      
