...
CREATE procedure [Staging].[spMKT_CreateRFMMovement_NewBKPDEL] /*'12/17/2000', '12/24/2000'*/
@PrevDate datetime, 
@EffDate datetime
AS
...
/*	select count(8) from Mapping.RFMlkValidCustomers	*/
		...
		from Archive.RFMHistory h
		join Mapping.RFMlkValidCustomers c
		...
		case when MadePurchase = 0 then 0 else 1 end
