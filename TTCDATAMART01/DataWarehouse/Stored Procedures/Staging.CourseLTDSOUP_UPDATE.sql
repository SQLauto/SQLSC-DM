...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [Staging].[CourseLTDSOUP_UPDATE] 
	@CourseID Int = 0
AS
...
if object_id('Staging.TempCourse_LTD_SOUP_UPDT') is not null drop table Staging.TempCourse_LTD_SOUP_UPDT
...
into Staging.TempCourse_LTD_SOUP_UPDT		
...
and c.CourseID > 50	
and c.ReleaseDate between '1/1/2015' and '1/7/2016'
...
delete a
from Marketing.Course_LTD_SOUP a join
	(select distinct courseid
	from Staging.TempCourse_LTD_SOUP_UPDT)b on a.courseid = b.CourseID

insert into Marketing.Course_LTD_SOUP
select * 
from Staging.TempCourse_LTD_SOUP_UPDT

drop table Staging.TempCourse_LTD_SOUP_UPDT
