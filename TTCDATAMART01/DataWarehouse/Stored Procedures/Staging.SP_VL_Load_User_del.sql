...
CREATE Proc [Staging].[SP_VL_Load_User_del]            
as            
Begin            
...
/*Truncate and Load */            
--Truncate table [Archive].[TGCPlus_User_del]             


Delete A from [Archive].[TGCPlus_User_del] A
Join [Staging].VL_ssis_User S
on A.uuid=s.uuid


            
insert into [Archive].[TGCPlus_User_del]            
...
Update [Archive].[TGCPlus_User_del]  
