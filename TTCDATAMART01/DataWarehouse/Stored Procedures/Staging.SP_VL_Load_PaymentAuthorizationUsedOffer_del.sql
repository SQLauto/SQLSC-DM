...
CREATE Proc [Staging].[SP_VL_Load_PaymentAuthorizationUsedOffer_del]   
as  
Begin  
  
   
/*Truncate and Load */  
--Truncate table [Archive].[TGCPlus_PaymentAuthorizationUsedOffer_del]  
...
Delete A from [Archive].[TGCPlus_PaymentAuthorizationUsedOffer_del] A
...
insert into [Archive].[TGCPlus_PaymentAuthorizationUsedOffer_del]  
  (pa_id,pa_user_id,uso_id,uso_version,uso_applied_at,uso_offer_id,uso_offer_code_applied,uso_redeemed_at,uso_uuid,uso_update_date,DMLastUpdateESTDateTime)  
