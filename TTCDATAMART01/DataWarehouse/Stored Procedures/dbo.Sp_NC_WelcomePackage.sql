...
set @SQL = 'exec staging.ExportTableToPipeText rfm, dbo, NCJFY69Mail_' + @CurrentWeekMondayID + '_CorpPress, ''\\File1\Groups\Marketing\WelcomePackages\DataFiles\2018_WP_Data'''              
exec (@SQL)              
    
    
--set @SQL = 'exec staging.ExportTableToPipeText rfm, dbo, NCJFY69Mail_BL_' + @CurrentWeekMondayID + '_CorpPress, ''\\File1\Groups\Marketing\WelcomePackages\DataFiles\2018_WP_Data'''              
--exec (@SQL)      
