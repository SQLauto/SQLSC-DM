...
--   SET @p_subject1 = N'EPC Failure - Preferences Changes have been Stopped'        
--   SET @p_body1 = '<b>EPC Failure - Preferences Changes have been Stopped in SP_Load_epc_preference</b>.'        
...
/*Only if change is less than */         if 1.*(@PrevCount-@NewCount)/(@PrevCount)< 0.02         
   Begin         
      Begin Tran        
     ...
     SELECT   EPC.Email as Emailaddress,CCS.CustomerID,EPC.NewCourseAnnouncements,          
         ...
         FlagValidEmail, FlagEmailPref, R3PurchWeb, FlagWebLTM18, Address1, Address2, City,               State, PostalCode, CountryCode, CountryName, FlagValidRegionUS,FlagInternational, Zip5,           
