...
CREATE Proc [Staging].[SP_VL_Load_SubscriptionOffer_del]  
as  
Begin  
  
   
/*Truncate and Load */  
--Truncate table [Archive].[TGCPlus_SubscriptionOffer_del]  

delete A from  [Archive].[TGCPlus_SubscriptionOffer_del]  A
join [Staging].VL_ssis_SubscriptionOffer  S
On A.id = S.id

  
insert into [Archive].[TGCPlus_SubscriptionOffer_del]  
