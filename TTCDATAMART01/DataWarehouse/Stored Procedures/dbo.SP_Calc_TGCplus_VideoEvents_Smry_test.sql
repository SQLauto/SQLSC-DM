...
CREATE Proc [dbo].[SP_Calc_TGCplus_VideoEvents_Smry_test] @FromDate date = null, @ToDate date = null
as
Begin
...
If @Todate is null
	...
	Delete from Datawarehouse.Marketing.TGCplus_VideoEvents_Smry_1
	where cast(tstamp as date) between @FromDate and @ToDate




	Insert into Datawarehouse.Marketing.TGCplus_VideoEvents_Smry_1
		SELECT 
			u.UUID,
			U.ID,
