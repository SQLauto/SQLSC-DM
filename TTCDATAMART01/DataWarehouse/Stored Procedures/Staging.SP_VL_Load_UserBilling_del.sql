...
CREATE Proc [Staging].[SP_VL_Load_UserBilling_del]    
as    
Begin    
    
    
/*Truncate and Load */    
--Truncate table [Archive].[TGCPlus_UserBilling_del]     
  
/*     
insert into [Archive].[TGCPlus_UserBilling_del]    
...
Delete A from [Archive].[TGCPlus_UserBilling_DEL]  A
