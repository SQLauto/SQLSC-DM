...
CREATE Proc [Staging].[SP_VL_Load_TGCplus_ConsumptionByPlatform_bkp_del]   @GreaterThanTStamp Date = null        
as          
Begin          
...
Truncate table staging.TGCPlus_ConsumptionByPlatform_temp_bkp_del        
...
insert into staging.TGCPlus_ConsumptionByPlatform_temp_bkp_del        
select   
  a.pfm as Platform,  
...
--Print 'Deleting'              
delete Marketing.TGCPlus_ConsumptionByPlatform_bkp_del        
where DatePlayed >= @GreaterThanTStamp     
        
Print 'Inserting'          
Insert into Marketing.TGCPlus_ConsumptionByPlatform_bkp_del        
select  *      
from staging.TGCPlus_ConsumptionByPlatform_temp_bkp_del      
      
      
update Marketing.TGCPlus_ConsumptionByPlatform_bkp_del  
