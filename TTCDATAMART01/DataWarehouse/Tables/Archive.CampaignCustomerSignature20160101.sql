CREATE TABLE [Archive].[CampaignCustomerSignature20160101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160101CustomerID] ON [Archive].[CampaignCustomerSignature20160101] ([CustomerID]) ON [ARCHIVE]
GO
