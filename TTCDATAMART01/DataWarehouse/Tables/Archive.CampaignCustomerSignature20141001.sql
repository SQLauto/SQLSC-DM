CREATE TABLE [Archive].[CampaignCustomerSignature20141001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20141001CustomerID] ON [Archive].[CampaignCustomerSignature20141001] ([CustomerID]) ON [ARCHIVE]
GO
