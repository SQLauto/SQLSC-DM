CREATE TABLE [Archive].[CampaignCustomerSignature20170101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170101CustomerID] ON [Archive].[CampaignCustomerSignature20170101] ([CustomerID]) ON [ARCHIVE]
GO
