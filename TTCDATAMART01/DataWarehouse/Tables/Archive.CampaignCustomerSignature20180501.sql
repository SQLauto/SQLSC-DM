CREATE TABLE [Archive].[CampaignCustomerSignature20180501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180501CustomerID] ON [Archive].[CampaignCustomerSignature20180501] ([CustomerID]) ON [ARCHIVE]
GO
