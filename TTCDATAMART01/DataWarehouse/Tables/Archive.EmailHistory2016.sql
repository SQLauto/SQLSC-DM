CREATE TABLE [Archive].[EmailHistory2016]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EmailHistory2016_TSTAMP_FlagHoldOut] ON [Archive].[EmailHistory2016] ([StartDate], [FlagHoldOut]) ON [PRIMARY]
GO
