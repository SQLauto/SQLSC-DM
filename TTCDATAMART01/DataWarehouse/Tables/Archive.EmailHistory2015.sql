CREATE TABLE [Archive].[EmailHistory2015]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EmailHistory2015_TSTAMP_FlagHoldOut] ON [Archive].[EmailHistory2015] ([StartDate], [FlagHoldOut]) ON [PRIMARY]
GO
