CREATE TABLE [Archive].[CampaignCustomerSignature20130401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130401CustomerID] ON [Archive].[CampaignCustomerSignature20130401] ([CustomerID]) ON [ARCHIVE]
GO
