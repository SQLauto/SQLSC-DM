CREATE TABLE [Archive].[CampaignCustomerSignature20160401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160401CustomerID] ON [Archive].[CampaignCustomerSignature20160401] ([CustomerID]) ON [ARCHIVE]
GO
