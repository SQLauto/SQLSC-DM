CREATE TABLE [Archive].[TGCPlus_VideoEvents_2018]
(
...
GO
ALTER TABLE [Archive].[TGCPlus_VideoEvents_2018] ADD CONSTRAINT [PK__TGCPlus___8EDBDD9E6A85C791] PRIMARY KEY CLUSTERED  ([TGCPlus_VideoEvents_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_TGCPlus_VideoEvents_2018_Tstamp] ON [Archive].[TGCPlus_VideoEvents_2018] ([tstamp]) ON [PRIMARY]
GO
