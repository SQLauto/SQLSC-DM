CREATE TABLE [Archive].[CampaignCustomerSignature20161101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20161101CustomerID] ON [Archive].[CampaignCustomerSignature20161101] ([CustomerID]) ON [ARCHIVE]
GO
