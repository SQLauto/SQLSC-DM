CREATE TABLE [Archive].[CampaignCustomerSignature20170301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170301CustomerID] ON [Archive].[CampaignCustomerSignature20170301] ([CustomerID]) ON [ARCHIVE]
GO
