CREATE TABLE [Archive].[CampaignCustomerSignature20120201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120201CustomerID] ON [Archive].[CampaignCustomerSignature20120201] ([CustomerID]) ON [ARCHIVE]
GO
