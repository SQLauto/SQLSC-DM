CREATE TABLE [Marketing].[DMCustomerDynamic]
(
...
[CostNLContactsSubsqMth] [money] NULL CONSTRAINT [DF_TempCustomerDynamic_CostNLContactsSubsqMth] DEFAULT ((0)),
[SwampSpContactsSubsqMth] [int] NOT NULL CONSTRAINT [DF_TempCustomerDynamic_SwampSpContactsSubsequentMth] DEFAULT ((0)),
[CostSwampSpContactsSubsqMth] [money] NULL CONSTRAINT [DF_TempCustomerDynamic_CostSwampSpContactsSubsqMth] DEFAULT ((0)),
[MagazineContactsSubsqMth] [int] NOT NULL CONSTRAINT [DF_TempCustomerDynamic_MagazineContactsSubsqMth] DEFAULT ((0)),
[CostMagazineContactsSubsqMth] [money] NULL CONSTRAINT [DF_TempCustomerDynamic_CostMagazineContactsSubsqMth] DEFAULT ((0)),
[LTDNewCourseSales] [money] NULL CONSTRAINT [DF_TempCustomerDynamic_LTDNewCourseSales] DEFAULT ((0)),
[NewCourseSalesSubsqMth] [money] NULL CONSTRAINT [DF_TempCustomerDynamic_NewCourseSalesSubsqMth] DEFAULT ((0)),
[YTDMagazinePurch] [int] NULL CONSTRAINT [DF_TempCustomerDynamic_YTDMagazinePurch] DEFAULT ((0)),
[YTDMagazineContacts] [int] NULL CONSTRAINT [DF_TempCustomerDynamic_YTDMagazineContacts] DEFAULT ((0)),
[YTDMagazineContactsBinID] [tinyint] NULL CONSTRAINT [DF_TempCustomerDynamic_YTDMagazineContactsBinID] DEFAULT ((0)),
