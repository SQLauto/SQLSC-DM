CREATE TABLE [Staging].[TempDMPurchaseOrders]
(
...
[GiftFlag] [bit] NULL CONSTRAINT [DF__TempDMPur__GiftF__29657343] DEFAULT ((0)),
...
GO
CREATE NONCLUSTERED INDEX [IX_TempDMPurchaseOrders_Temp1] ON [Staging].[TempDMPurchaseOrders] ([CustomerID], [DateOrdered], [OrderID], [SequenceNum]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_TempDMPurchaseOrders_OrderID] ON [Staging].[TempDMPurchaseOrders] ([OrderID]) ON [PRIMARY]
GO
