CREATE TABLE [Archive].[CampaignCustomerSignature20151101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20151101CustomerID] ON [Archive].[CampaignCustomerSignature20151101] ([CustomerID]) ON [ARCHIVE]
GO
