...
GO
ALTER TABLE [Archive].[Omni_TGCPlus_AcquisitionDashboard] ADD CONSTRAINT [PK__Omni_TGC__23574203D77CFDBE] PRIMARY KEY CLUSTERED  ([Omni_TGCPlus_AcquisitionDashboard_id]) ON [PRIMARY]
GO
