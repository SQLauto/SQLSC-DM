CREATE TABLE [Archive].[CampaignCustomerSignature20121001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20121001CustomerID] ON [Archive].[CampaignCustomerSignature20121001] ([CustomerID]) ON [ARCHIVE]
GO
