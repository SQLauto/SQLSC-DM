CREATE TABLE [dbo].[DMCustDyanamic_YearlyAnalysis]
(
...
[Parts] [money] NOT NULL,
[Units] [int] NOT NULL,
[OrdersWithCoupon] [int] NOT NULL,
[SalesWithCoupon] [money] NOT NULL,
[Sales_Digital] [money] NOT NULL,
[Sales_Physical] [money] NOT NULL,
[Parts_Digital] [money] NOT NULL,
[Parts_physical] [money] NOT NULL,
[Units_Digital] [int] NOT NULL,
[Units_Physical] [int] NOT NULL,
[TotalDiscount] [money] NOT NULL,
[MailContacts] [int] NOT NULL,
[EmailContacts] [int] NOT NULL,
[SteamedSeconds] [float] NOT NULL,
[TotalActions] [int] NOT NULL,
[StreamSeconds_audio] [float] NOT NULL,
[TotalActions_audio] [int] NOT NULL,
[StreamSeconds_Video] [float] NOT NULL,
[TotalActions_Video] [int] NOT NULL,
[StreamSeconds_Web] [float] NOT NULL,
[TotalActions_Web] [int] NOT NULL,
[StreamSeconds_AndroidApp] [float] NOT NULL,
[TotalActions_AndroidApp] [int] NOT NULL,
[StreamSeconds_iOSapp] [float] NOT NULL,
[TotalActions_iOSapp] [int] NOT NULL
) ON [PRIMARY]
GO
