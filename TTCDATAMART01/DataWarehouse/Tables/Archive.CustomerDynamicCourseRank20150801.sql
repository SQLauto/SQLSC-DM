CREATE TABLE [Archive].[CustomerDynamicCourseRank20150801]
(
...
GO
CREATE CLUSTERED INDEX [pkCustomerDynamicCourseRank20150801CustomerID] ON [Archive].[CustomerDynamicCourseRank20150801] ([CustomerID]) ON [ARCHIVE]
GO
