CREATE TABLE [Archive].[Mail_US_SeptCatalog_20160819]
(
...
[DemiDecile] [int] NULL,
[RAMSelect] [int] NULL,
[CraftsyCat2CTLMB] [int] NULL,
[TopCustHoldout] [int] NULL,
[CleanControlTest] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
