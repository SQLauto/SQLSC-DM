CREATE TABLE [Archive].[CampaignCustomerSignature20131001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20131001CustomerID] ON [Archive].[CampaignCustomerSignature20131001] ([CustomerID]) ON [ARCHIVE]
GO
