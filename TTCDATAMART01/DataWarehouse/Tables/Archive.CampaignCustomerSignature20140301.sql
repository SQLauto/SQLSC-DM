CREATE TABLE [Archive].[CampaignCustomerSignature20140301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140301CustomerID] ON [Archive].[CampaignCustomerSignature20140301] ([CustomerID]) ON [ARCHIVE]
GO
