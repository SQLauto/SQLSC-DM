CREATE TABLE [Marketing].[DMCustomerDynamic2009to2015Jan]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_DMCS0915_1] ON [Marketing].[DMCustomerDynamic2009to2015Jan] ([AsOfDate]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DMCS0915_2] ON [Marketing].[DMCustomerDynamic2009to2015Jan] ([CustomerID]) ON [PRIMARY]
GO
