CREATE TABLE [Archive].[CampaignCustomerSignature20170201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170201CustomerID] ON [Archive].[CampaignCustomerSignature20170201] ([CustomerID]) ON [ARCHIVE]
GO
