CREATE TABLE [Archive].[CampaignCustomerSignature20170701]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170701CustomerID] ON [Archive].[CampaignCustomerSignature20170701] ([CustomerID]) ON [ARCHIVE]
GO
