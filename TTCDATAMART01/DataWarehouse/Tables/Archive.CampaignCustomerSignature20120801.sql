CREATE TABLE [Archive].[CampaignCustomerSignature20120801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120801CustomerID] ON [Archive].[CampaignCustomerSignature20120801] ([CustomerID]) ON [ARCHIVE]
GO
