CREATE TABLE [Archive].[CampaignCustomerSignature20130601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130601CustomerID] ON [Archive].[CampaignCustomerSignature20130601] ([CustomerID]) ON [ARCHIVE]
GO
