CREATE TABLE [Archive].[CampaignCustomerSignature20140401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140401CustomerID] ON [Archive].[CampaignCustomerSignature20140401] ([CustomerID]) ON [ARCHIVE]
GO
