CREATE TABLE [Archive].[EmailEngagement_1monthforward_3]
(
...
[Emails_Sent_1_mon] [int] NULL,
[Cnt_engaged] [int] NULL,
[Cnt_clicked] [int] NULL,
[Cnt_opened] [int] NULL,
[NumberOfOrders] [int] NULL,
[NumberOfEmailOrders] [int] NULL,
[NetOrderAmount] [money] NULL,
[NetOrderAmountEmail] [money] NULL
) ON [PRIMARY]
GO
