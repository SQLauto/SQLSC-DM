CREATE TABLE [Archive].[CampaignCustomerSignature20140901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140901CustomerID] ON [Archive].[CampaignCustomerSignature20140901] ([CustomerID]) ON [ARCHIVE]
GO
