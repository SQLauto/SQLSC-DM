CREATE TABLE [Archive].[CampaignCustomerSignature20150401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150401CustomerID] ON [Archive].[CampaignCustomerSignature20150401] ([CustomerID]) ON [ARCHIVE]
GO
