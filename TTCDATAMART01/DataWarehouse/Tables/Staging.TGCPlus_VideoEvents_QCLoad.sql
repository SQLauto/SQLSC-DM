CREATE TABLE [Staging].[TGCPlus_VideoEvents_QCLoad]
(
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20180212-174131] ON [Staging].[TGCPlus_VideoEvents_QCLoad] ([tstamp], [pfm]) ON [PRIMARY]
GO
