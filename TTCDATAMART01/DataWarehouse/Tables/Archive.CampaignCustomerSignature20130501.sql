CREATE TABLE [Archive].[CampaignCustomerSignature20130501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130501CustomerID] ON [Archive].[CampaignCustomerSignature20130501] ([CustomerID]) ON [ARCHIVE]
GO
