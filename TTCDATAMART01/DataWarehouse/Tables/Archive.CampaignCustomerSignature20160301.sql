CREATE TABLE [Archive].[CampaignCustomerSignature20160301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160301CustomerID] ON [Archive].[CampaignCustomerSignature20160301] ([CustomerID]) ON [ARCHIVE]
GO
