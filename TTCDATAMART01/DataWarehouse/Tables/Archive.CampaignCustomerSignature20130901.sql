CREATE TABLE [Archive].[CampaignCustomerSignature20130901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130901CustomerID] ON [Archive].[CampaignCustomerSignature20130901] ([CustomerID]) ON [ARCHIVE]
GO
