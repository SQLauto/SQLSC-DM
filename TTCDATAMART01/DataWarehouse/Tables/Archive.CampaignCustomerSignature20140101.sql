CREATE TABLE [Archive].[CampaignCustomerSignature20140101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140101CustomerID] ON [Archive].[CampaignCustomerSignature20140101] ([CustomerID]) ON [ARCHIVE]
GO
