CREATE TABLE [Archive].[CampaignCustomerSignature20180601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180601CustomerID] ON [Archive].[CampaignCustomerSignature20180601] ([CustomerID]) ON [ARCHIVE]
GO
