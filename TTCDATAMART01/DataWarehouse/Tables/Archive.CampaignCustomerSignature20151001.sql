CREATE TABLE [Archive].[CampaignCustomerSignature20151001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20151001CustomerID] ON [Archive].[CampaignCustomerSignature20151001] ([CustomerID]) ON [ARCHIVE]
GO
