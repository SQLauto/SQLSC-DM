CREATE TABLE [Marketing].[TGCPLus_AppsFlyer_AppEvents]
(
[TGCPLus_AppsFlyer_AppEvents_id] [int] NULL,
...
GO
CREATE UNIQUE CLUSTERED INDEX [PX_TGCPLus_AppsFlyer_AppEvents] ON [Marketing].[TGCPLus_AppsFlyer_AppEvents] ([CustomerUserID]) ON [PRIMARY]
GO
