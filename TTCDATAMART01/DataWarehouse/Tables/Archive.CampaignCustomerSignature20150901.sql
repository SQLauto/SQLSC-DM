CREATE TABLE [Archive].[CampaignCustomerSignature20150901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150901CustomerID] ON [Archive].[CampaignCustomerSignature20150901] ([CustomerID]) ON [ARCHIVE]
GO
