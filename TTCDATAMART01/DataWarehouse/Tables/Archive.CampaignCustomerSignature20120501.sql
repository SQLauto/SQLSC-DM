CREATE TABLE [Archive].[CampaignCustomerSignature20120501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120501CustomerID] ON [Archive].[CampaignCustomerSignature20120501] ([CustomerID]) ON [ARCHIVE]
GO
