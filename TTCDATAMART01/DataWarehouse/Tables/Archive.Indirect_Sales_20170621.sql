CREATE TABLE [Archive].[Indirect_Sales_20170621]
(
...
GO
ALTER TABLE [Archive].[Indirect_Sales_20170621] ADD CONSTRAINT [PK__Indirect__564DD84A85005615] PRIMARY KEY CLUSTERED  ([Indirect_Sales]) ON [PRIMARY]
GO
