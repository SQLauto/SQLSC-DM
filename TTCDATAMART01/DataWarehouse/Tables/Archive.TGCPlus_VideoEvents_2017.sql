CREATE TABLE [Archive].[TGCPlus_VideoEvents_2017]
(
...
GO
ALTER TABLE [Archive].[TGCPlus_VideoEvents_2017] ADD CONSTRAINT [PK__TGCPlus___8EDBDD9EB427A2FA] PRIMARY KEY CLUSTERED  ([TGCPlus_VideoEvents_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_TGCPlus_VideoEvents_2017_Tstamp] ON [Archive].[TGCPlus_VideoEvents_2017] ([tstamp]) ON [PRIMARY]
GO
