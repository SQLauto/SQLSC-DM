CREATE TABLE [Archive].[CampaignCustomerSignature20150701]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150701CustomerID] ON [Archive].[CampaignCustomerSignature20150701] ([CustomerID]) ON [ARCHIVE]
GO
