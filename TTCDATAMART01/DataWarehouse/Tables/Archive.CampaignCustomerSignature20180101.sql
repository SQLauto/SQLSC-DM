CREATE TABLE [Archive].[CampaignCustomerSignature20180101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180101CustomerID] ON [Archive].[CampaignCustomerSignature20180101] ([CustomerID]) ON [ARCHIVE]
GO
