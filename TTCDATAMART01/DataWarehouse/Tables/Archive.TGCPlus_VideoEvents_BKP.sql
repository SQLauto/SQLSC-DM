CREATE TABLE [Archive].[TGCPlus_VideoEvents_BKP]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_TGCPlus_VideoEvents_Tstamp] ON [Archive].[TGCPlus_VideoEvents_BKP] ([tstamp]) ON [PRIMARY]
GO
