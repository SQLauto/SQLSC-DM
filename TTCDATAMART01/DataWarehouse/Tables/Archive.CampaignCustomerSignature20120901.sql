CREATE TABLE [Archive].[CampaignCustomerSignature20120901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120901CustomerID] ON [Archive].[CampaignCustomerSignature20120901] ([CustomerID]) ON [ARCHIVE]
GO
