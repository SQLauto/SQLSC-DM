CREATE TABLE [Archive].[CampaignCustomerSignature20151201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20151201CustomerID] ON [Archive].[CampaignCustomerSignature20151201] ([CustomerID]) ON [ARCHIVE]
GO
