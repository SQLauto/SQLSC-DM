CREATE TABLE [Archive].[CampaignCustomerSignature20180401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180401CustomerID] ON [Archive].[CampaignCustomerSignature20180401] ([CustomerID]) ON [ARCHIVE]
GO
