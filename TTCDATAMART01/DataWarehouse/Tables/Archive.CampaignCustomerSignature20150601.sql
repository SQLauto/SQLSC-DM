CREATE TABLE [Archive].[CampaignCustomerSignature20150601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150601CustomerID] ON [Archive].[CampaignCustomerSignature20150601] ([CustomerID]) ON [ARCHIVE]
GO
