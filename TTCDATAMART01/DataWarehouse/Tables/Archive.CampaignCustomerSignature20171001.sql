CREATE TABLE [Archive].[CampaignCustomerSignature20171001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20171001CustomerID] ON [Archive].[CampaignCustomerSignature20171001] ([CustomerID]) ON [ARCHIVE]
GO
