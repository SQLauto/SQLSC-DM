CREATE TABLE [Marketing].[DMPurchaseOrders]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_DMPurchaseOrders_Temp2] ON [Marketing].[DMPurchaseOrders] ([OrderID], [CustomerID], [SequenceNum], [DateOrdered], [NetOrderAmount]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DMPurchaseOrders_Temp1] ON [Marketing].[DMPurchaseOrders] ([SequenceNum], [DateOrdered], [DaysSinceLastPurchase], [NetOrderAmount]) INCLUDE ([CustomerID], [OrderID], [PriorPurchaseOrderID]) ON [PRIMARY]
GO
