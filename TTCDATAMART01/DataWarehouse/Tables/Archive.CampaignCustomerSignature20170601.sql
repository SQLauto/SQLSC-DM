CREATE TABLE [Archive].[CampaignCustomerSignature20170601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170601CustomerID] ON [Archive].[CampaignCustomerSignature20170601] ([CustomerID]) ON [ARCHIVE]
GO
