CREATE TABLE [Archive].[CampaignCustomerSignature20180201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180201CustomerID] ON [Archive].[CampaignCustomerSignature20180201] ([CustomerID]) ON [ARCHIVE]
GO
