CREATE TABLE [Archive].[CampaignCustomerSignature20140601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140601CustomerID] ON [Archive].[CampaignCustomerSignature20140601] ([CustomerID]) ON [ARCHIVE]
GO
