CREATE TABLE [Archive].[CampaignCustomerSignature20130201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130201CustomerID] ON [Archive].[CampaignCustomerSignature20130201] ([CustomerID]) ON [ARCHIVE]
GO
