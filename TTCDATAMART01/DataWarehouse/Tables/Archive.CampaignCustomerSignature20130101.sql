CREATE TABLE [Archive].[CampaignCustomerSignature20130101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130101CustomerID] ON [Archive].[CampaignCustomerSignature20130101] ([CustomerID]) ON [ARCHIVE]
GO
