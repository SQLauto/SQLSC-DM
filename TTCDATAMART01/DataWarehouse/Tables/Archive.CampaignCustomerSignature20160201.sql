CREATE TABLE [Archive].[CampaignCustomerSignature20160201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160201CustomerID] ON [Archive].[CampaignCustomerSignature20160201] ([CustomerID]) ON [ARCHIVE]
GO
