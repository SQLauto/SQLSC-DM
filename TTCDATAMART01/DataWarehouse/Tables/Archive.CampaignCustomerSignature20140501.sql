CREATE TABLE [Archive].[CampaignCustomerSignature20140501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140501CustomerID] ON [Archive].[CampaignCustomerSignature20140501] ([CustomerID]) ON [ARCHIVE]
GO
