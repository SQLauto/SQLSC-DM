CREATE TABLE [Archive].[CampaignCustomerSignature20121101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20121101CustomerID] ON [Archive].[CampaignCustomerSignature20121101] ([CustomerID]) ON [ARCHIVE]
GO
