CREATE TABLE [Archive].[CampaignCustomerSignature20140201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140201CustomerID] ON [Archive].[CampaignCustomerSignature20140201] ([CustomerID]) ON [ARCHIVE]
GO
