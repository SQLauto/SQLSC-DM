CREATE TABLE [Archive].[CampaignCustomerSignature20120301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120301CustomerID] ON [Archive].[CampaignCustomerSignature20120301] ([CustomerID]) ON [ARCHIVE]
GO
