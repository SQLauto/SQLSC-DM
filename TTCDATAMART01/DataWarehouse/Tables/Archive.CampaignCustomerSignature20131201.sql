CREATE TABLE [Archive].[CampaignCustomerSignature20131201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20131201CustomerID] ON [Archive].[CampaignCustomerSignature20131201] ([CustomerID]) ON [ARCHIVE]
GO
