CREATE TABLE [Archive].[CampaignCustomerSignature20141101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20141101CustomerID] ON [Archive].[CampaignCustomerSignature20141101] ([CustomerID]) ON [ARCHIVE]
GO
