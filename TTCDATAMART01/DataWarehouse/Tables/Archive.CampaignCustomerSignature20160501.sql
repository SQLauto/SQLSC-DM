CREATE TABLE [Archive].[CampaignCustomerSignature20160501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160501CustomerID] ON [Archive].[CampaignCustomerSignature20160501] ([CustomerID]) ON [ARCHIVE]
GO
