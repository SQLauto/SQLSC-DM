...
[StreamedCountryCode] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[DMlastupdated] [datetime] NULL CONSTRAINT [DF__omni_TGC___DMlas__370D7BA8] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Archive].[omni_TGC_Web_Streaming] ADD CONSTRAINT [PK__omni_TGC__181DDC0D12BE64B1] PRIMARY KEY CLUSTERED  ([omni_TGC_Web_Streaming_id]) ON [PRIMARY]
GO
