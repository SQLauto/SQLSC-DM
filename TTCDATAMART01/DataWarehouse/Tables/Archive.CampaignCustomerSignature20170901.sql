CREATE TABLE [Archive].[CampaignCustomerSignature20170901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170901CustomerID] ON [Archive].[CampaignCustomerSignature20170901] ([CustomerID]) ON [ARCHIVE]
GO
