CREATE TABLE [Archive].[Indirect_Sales2]
(
...
GO
ALTER TABLE [Archive].[Indirect_Sales2] ADD CONSTRAINT [PK__Indirect__564DD84A7C3A4214] PRIMARY KEY CLUSTERED  ([Indirect_Sales]) ON [PRIMARY]
GO
