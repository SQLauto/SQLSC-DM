CREATE TABLE [Archive].[CampaignCustomerSignature20150201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150201CustomerID] ON [Archive].[CampaignCustomerSignature20150201] ([CustomerID]) ON [ARCHIVE]
GO
