CREATE TABLE [Archive].[CampaignCustomerSignature20160901]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160901CustomerID] ON [Archive].[CampaignCustomerSignature20160901] ([CustomerID]) ON [ARCHIVE]
GO
