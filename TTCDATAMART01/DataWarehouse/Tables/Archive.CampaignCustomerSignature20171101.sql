CREATE TABLE [Archive].[CampaignCustomerSignature20171101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20171101CustomerID] ON [Archive].[CampaignCustomerSignature20171101] ([CustomerID]) ON [ARCHIVE]
GO
