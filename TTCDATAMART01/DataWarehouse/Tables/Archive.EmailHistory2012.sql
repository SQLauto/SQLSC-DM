CREATE TABLE [Archive].[EmailHistory2012]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EmailHistory2012_TSTAMP_FlagHoldOut] ON [Archive].[EmailHistory2012] ([StartDate], [FlagHoldOut]) ON [PRIMARY]
GO
