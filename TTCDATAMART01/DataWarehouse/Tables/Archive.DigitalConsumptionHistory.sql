CREATE TABLE [Archive].[DigitalConsumptionHistory]
(
...
GO
ALTER TABLE [Archive].[DigitalConsumptionHistory] ADD CONSTRAINT [PK__DigitalC__43A7CB2D5AFCCED7] PRIMARY KEY CLUSTERED  ([DigitalConsumptionHistory_ID]) ON [PRIMARY]
GO
