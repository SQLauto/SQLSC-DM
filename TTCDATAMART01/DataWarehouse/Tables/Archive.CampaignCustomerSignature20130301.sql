CREATE TABLE [Archive].[CampaignCustomerSignature20130301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130301CustomerID] ON [Archive].[CampaignCustomerSignature20130301] ([CustomerID]) ON [ARCHIVE]
GO
