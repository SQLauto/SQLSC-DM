CREATE TABLE [Archive].[CampaignCustomerSignature20140801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140801CustomerID] ON [Archive].[CampaignCustomerSignature20140801] ([CustomerID]) ON [ARCHIVE]
GO
