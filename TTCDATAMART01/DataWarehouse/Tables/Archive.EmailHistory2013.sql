CREATE TABLE [Archive].[EmailHistory2013]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EmailHistory2013_TSTAMP_FlagHoldOut] ON [Archive].[EmailHistory2013] ([StartDate], [FlagHoldOut]) ON [PRIMARY]
GO
