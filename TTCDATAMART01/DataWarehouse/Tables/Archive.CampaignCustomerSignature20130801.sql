CREATE TABLE [Archive].[CampaignCustomerSignature20130801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130801CustomerID] ON [Archive].[CampaignCustomerSignature20130801] ([CustomerID]) ON [ARCHIVE]
GO
