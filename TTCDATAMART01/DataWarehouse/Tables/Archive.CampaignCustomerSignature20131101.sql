CREATE TABLE [Archive].[CampaignCustomerSignature20131101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20131101CustomerID] ON [Archive].[CampaignCustomerSignature20131101] ([CustomerID]) ON [ARCHIVE]
GO
