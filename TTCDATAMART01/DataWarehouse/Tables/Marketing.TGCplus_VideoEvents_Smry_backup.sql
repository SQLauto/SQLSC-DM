CREATE TABLE [Marketing].[TGCplus_VideoEvents_Smry_backup]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_TGCplus_VideoEvents_Smry_TSTAMP] ON [Marketing].[TGCplus_VideoEvents_Smry_backup] ([TSTAMP]) INCLUDE ([ID]) ON [PRIMARY]
GO
