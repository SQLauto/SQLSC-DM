CREATE TABLE [Archive].[CampaignCustomerSignature20170401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170401CustomerID] ON [Archive].[CampaignCustomerSignature20170401] ([CustomerID]) ON [ARCHIVE]
GO
