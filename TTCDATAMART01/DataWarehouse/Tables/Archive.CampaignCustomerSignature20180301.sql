CREATE TABLE [Archive].[CampaignCustomerSignature20180301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20180301CustomerID] ON [Archive].[CampaignCustomerSignature20180301] ([CustomerID]) ON [ARCHIVE]
GO
