CREATE TABLE [Staging].[TempMailReports]
(
...
[GenderFlag] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[AgeBin] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[VLDCustGroup] [varchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[MTH] [tinyint] NULL,
[fw] [tinyint] NULL,
[pr] [tinyint] NULL,
[ec] [tinyint] NULL,
[FlagECPRFWMTH] [int] NULL,
[JFY2_Adcode] [int] NULL
) ON [PRIMARY]
GO
