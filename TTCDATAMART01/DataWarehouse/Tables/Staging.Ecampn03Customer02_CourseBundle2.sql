CREATE TABLE [Staging].[Ecampn03Customer02_CourseBundle2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_Ecampn03Customer02_CourseBundle21] ON [Staging].[Ecampn03Customer02_CourseBundle2] ([Customerid]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_Ecampn03Customer02_CourseBundle22] ON [Staging].[Ecampn03Customer02_CourseBundle2] ([Rank2]) ON [PRIMARY]
GO
