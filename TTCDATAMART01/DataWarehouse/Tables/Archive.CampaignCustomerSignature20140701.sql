CREATE TABLE [Archive].[CampaignCustomerSignature20140701]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20140701CustomerID] ON [Archive].[CampaignCustomerSignature20140701] ([CustomerID]) ON [ARCHIVE]
GO
