CREATE TABLE [Archive].[CampaignCustomerSignature20121201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20121201CustomerID] ON [Archive].[CampaignCustomerSignature20121201] ([CustomerID]) ON [ARCHIVE]
GO
