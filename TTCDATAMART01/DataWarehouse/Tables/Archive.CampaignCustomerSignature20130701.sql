CREATE TABLE [Archive].[CampaignCustomerSignature20130701]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20130701CustomerID] ON [Archive].[CampaignCustomerSignature20130701] ([CustomerID]) ON [ARCHIVE]
GO
