CREATE TABLE [Archive].[CampaignCustomerSignature20160601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160601CustomerID] ON [Archive].[CampaignCustomerSignature20160601] ([CustomerID]) ON [ARCHIVE]
GO
