CREATE TABLE [Archive].[CampaignCustomerSignature20170501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170501CustomerID] ON [Archive].[CampaignCustomerSignature20170501] ([CustomerID]) ON [ARCHIVE]
GO
