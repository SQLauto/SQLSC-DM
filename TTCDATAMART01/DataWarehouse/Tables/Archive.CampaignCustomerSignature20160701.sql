CREATE TABLE [Archive].[CampaignCustomerSignature20160701]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160701CustomerID] ON [Archive].[CampaignCustomerSignature20160701] ([CustomerID]) ON [ARCHIVE]
GO
