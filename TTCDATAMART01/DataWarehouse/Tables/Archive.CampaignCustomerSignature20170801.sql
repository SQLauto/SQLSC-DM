CREATE TABLE [Archive].[CampaignCustomerSignature20170801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20170801CustomerID] ON [Archive].[CampaignCustomerSignature20170801] ([CustomerID]) ON [ARCHIVE]
GO
