CREATE TABLE [Archive].[CampaignCustomerSignature20160801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20160801CustomerID] ON [Archive].[CampaignCustomerSignature20160801] ([CustomerID]) ON [ARCHIVE]
GO
