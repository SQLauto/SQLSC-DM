CREATE TABLE [Archive].[CampaignCustomerSignature20171201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20171201CustomerID] ON [Archive].[CampaignCustomerSignature20171201] ([CustomerID]) ON [ARCHIVE]
GO
