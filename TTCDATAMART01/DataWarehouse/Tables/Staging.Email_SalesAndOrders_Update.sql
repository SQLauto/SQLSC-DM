CREATE TABLE [Staging].[Email_SalesAndOrders_Update]
(
[CampaignID] [int] NULL,
...
GO
CREATE NONCLUSTERED INDEX [idx_Email_SalesAndOrders_Update_Adcode] ON [Staging].[Email_SalesAndOrders_Update] ([Adcode]) INCLUDE ([CustomerID]) ON [PRIMARY]
GO
