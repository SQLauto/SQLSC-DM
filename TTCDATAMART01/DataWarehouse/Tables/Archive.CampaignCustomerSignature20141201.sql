CREATE TABLE [Archive].[CampaignCustomerSignature20141201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20141201CustomerID] ON [Archive].[CampaignCustomerSignature20141201] ([CustomerID]) ON [ARCHIVE]
GO
