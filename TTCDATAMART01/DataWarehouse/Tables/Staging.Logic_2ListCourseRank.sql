...
GO
ALTER TABLE [Staging].[Logic_2ListCourseRank] ADD CONSTRAINT [UC_Logic_2ListCourseRank] UNIQUE NONCLUSTERED  ([ListID], [CourseID], [DisplayOrder], [UpsellCourseID]) ON [PRIMARY]
GO
