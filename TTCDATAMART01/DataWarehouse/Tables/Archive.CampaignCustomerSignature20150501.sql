CREATE TABLE [Archive].[CampaignCustomerSignature20150501]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150501CustomerID] ON [Archive].[CampaignCustomerSignature20150501] ([CustomerID]) ON [ARCHIVE]
GO
