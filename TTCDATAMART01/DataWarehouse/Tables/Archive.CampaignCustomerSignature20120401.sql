CREATE TABLE [Archive].[CampaignCustomerSignature20120401]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120401CustomerID] ON [Archive].[CampaignCustomerSignature20120401] ([CustomerID]) ON [ARCHIVE]
GO
