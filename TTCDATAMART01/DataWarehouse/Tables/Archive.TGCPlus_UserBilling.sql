CREATE TABLE [Archive].[TGCPlus_UserBilling]
(
[id] [bigint] NOT NULL,
[version] [bigint] NULL,
...
[DMLastUpdateESTDateTime] [datetime] NOT NULL CONSTRAINT [DF__TGCPlus_U__DMLas__31171164] DEFAULT (getdate()),
[payment_handler] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_TGCplus_UserBilling] ON [Archive].[TGCPlus_UserBilling] ([id]) ON [PRIMARY]
GO
