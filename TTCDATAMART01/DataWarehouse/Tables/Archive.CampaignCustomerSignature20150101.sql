CREATE TABLE [Archive].[CampaignCustomerSignature20150101]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150101CustomerID] ON [Archive].[CampaignCustomerSignature20150101] ([CustomerID]) ON [ARCHIVE]
GO
