CREATE TABLE [Archive].[CampaignCustomerSignature20150301]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150301CustomerID] ON [Archive].[CampaignCustomerSignature20150301] ([CustomerID]) ON [ARCHIVE]
GO
