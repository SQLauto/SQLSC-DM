CREATE TABLE [Archive].[CampaignCustomerSignature20150801]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20150801CustomerID] ON [Archive].[CampaignCustomerSignature20150801] ([CustomerID]) ON [ARCHIVE]
GO
