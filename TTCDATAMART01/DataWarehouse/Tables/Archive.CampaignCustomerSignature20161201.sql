CREATE TABLE [Archive].[CampaignCustomerSignature20161201]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20161201CustomerID] ON [Archive].[CampaignCustomerSignature20161201] ([CustomerID]) ON [ARCHIVE]
GO
