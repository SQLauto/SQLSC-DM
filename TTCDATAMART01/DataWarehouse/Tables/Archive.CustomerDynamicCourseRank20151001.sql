CREATE TABLE [Archive].[CustomerDynamicCourseRank20151001]
(
...
GO
CREATE CLUSTERED INDEX [pkCustomerDynamicCourseRank20151001CustomerID] ON [Archive].[CustomerDynamicCourseRank20151001] ([CustomerID]) ON [ARCHIVE]
GO
