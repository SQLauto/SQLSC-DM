CREATE TABLE [Mapping].[TGCplus_Merge_Dupes]
(
...
[kept_drop] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[keptpin] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[TGCPlusCustomerid] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Rank] [bigint] NULL,
[Merge_Date] [date] NULL
) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_TGCplus_Merge_Dupes] ON [Mapping].[TGCplus_Merge_Dupes] ([Merge_Date], [acctno], [TGCPlusCustomerid], [Rank], [keptpin]) ON [PRIMARY]
GO
