CREATE TABLE [Archive].[TGCPlus_PaymentAuthorizationStatus_ROKU_BKP_20170220]
(
[pa_id] [bigint] NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_TGCPlus_PaymentAuthorizationStatus_ROKU_BKP_20170220] ON [Archive].[TGCPlus_PaymentAuthorizationStatus_ROKU_BKP_20170220] ([pas_id]) ON [PRIMARY]
GO
