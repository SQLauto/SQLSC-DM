CREATE TABLE [Archive].[CampaignCustomerSignature20161001]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20161001CustomerID] ON [Archive].[CampaignCustomerSignature20161001] ([CustomerID]) ON [ARCHIVE]
GO
