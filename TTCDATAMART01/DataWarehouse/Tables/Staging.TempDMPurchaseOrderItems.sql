CREATE TABLE [Staging].[TempDMPurchaseOrderItems]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_TempDMPurchaseOrderItems_StockItemID] ON [Staging].[TempDMPurchaseOrderItems] ([StockItemID]) ON [PRIMARY]
GO
