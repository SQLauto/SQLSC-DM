CREATE TABLE [Archive].[CampaignCustomerSignature20120601]
(
...
GO
CREATE CLUSTERED INDEX [pkCampaignCustomerSignature20120601CustomerID] ON [Archive].[CampaignCustomerSignature20120601] ([CustomerID]) ON [ARCHIVE]
GO
