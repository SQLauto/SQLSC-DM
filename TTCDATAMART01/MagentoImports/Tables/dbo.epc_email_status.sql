CREATE TABLE [dbo].[epc_email_status]
(
...
GO
ALTER TABLE [dbo].[epc_email_status] ADD CONSTRAINT [PK__epc_emai__B4816FAB5CA1C101] PRIMARY KEY CLUSTERED  ([recipient_failure_id]) ON [PRIMARY]
GO
